...
int f27() {
    int r[MAX], a[MAX], b[MAX], na, nb, temp, temp1;

    puts("Funcao 27 -> Funcao merge, que dados dois vetores ordenados, preenche o vetor r com os elementos de a e b ordenados. Quantos elementos tem o primeiro vetor?");
    scanf("%i", &na);
    for(int i = 0; i<=na; i++) {
        puts("Insere um numero:");
        scanf("%i",&a[i]);
    ...
    puts("Quantos elementos tem o segundo elemento?");
    scanf("%i", &nb);
    for(int i = 0; i<=nb; i++) {
        puts("Insere um numero:");
        scanf("%i",&b[i]);
